...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (pg_num_rows($check_result) > 0) {
            // Se l'email esiste già, imposta la variabile JavaScript per mostrare il messaggio
            echo '<script>';
...
<body>
            ...
            <div class="col-md-6">
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body color_card">
                        <!-- form di sign_up -->
                        <form name="loginForm" action="sign_up.php" method="POST" onsubmit="return validateForm()">
    ...
    <!-- div per errore in caso siano già presenti le credenziali nel database -->
    ...
    <script>
        ...
        // Mostra o nasconde il messaggio di avvertimento in base alla variabile JavaScript
        if (showMessageBox) {
            showMessage();
        } else {
            hideMessage();
         ...
         <!-- div per errore in caso di email istituzionale non valida -->
    <div id="messageBox2" class="text-center">
        <p>
            Attenzione! Sembra tu non abbia un e-mail istituzionale valida. Registrati come ospite <a class="color_link" href="sign_up_ospite.php">QUI</a>
        </p>
    </div>
    ...
    <script>
        ...
        function validateForm() {
            ...
            const email_regex = /^[a-z]+\.[0-9]+@studenti\.uniroma1\.it$/;
            const email_regex_prof = /^[a-z]+\.[a-z]@uniroma1\.it$/;
            ...
            if (!email_regex.test(email) && !email_regex_prof.test(email)) {
